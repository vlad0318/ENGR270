...
MP_PROCESSOR_OPTION=PIC18F1220
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Lab_1.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
${DISTDIR}/Lab_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F1220 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Lab_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
